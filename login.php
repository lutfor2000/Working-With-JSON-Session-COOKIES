<?php
 session_start();
 //Submit login button check User name password and go to dashboard
 if(isset($_POST['name']) && isset($_POST['password'])){
    $name = $_POST['name'];
    $password = $_POST['password']; 
    if($name == "Lutfor" && $password == "lutfor123"){
        //=======Data Send Page Start==========================>
        $_SESSION['user'] = $name;
        ...
        echo "Invalided User Name And Password !";
    }
 }

//========Once the profile is logged in, the login page will not show================================>
